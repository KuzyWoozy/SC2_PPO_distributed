...
class MiniStarPolicy(t.nn.Module):
    ...
    def __init__(self):
        ...
        self.convolve2 = t.nn.Conv2d(6, 12, 3, stride = 1, padding = "same")

        self.hidden = t.nn.Linear(49152, NN_HIDDEN_LAYER)
        
        self.function_id = t.nn.Linear(NN_HIDDEN_LAYER, NUM_ACTIONS)
        
        self.coords1 = t.nn.Conv2d(12, 1, 1, stride = 1)
        self.coords2 = t.nn.Conv2d(12, 1, 1, stride = 1)
