...
from src.Config import LEARNING_RATE, EPOCH_BATCH, LAMBDA, ENTROPY, NN_HIDDEN_LAYER, NUM_ACTIONS, PPO_CLIP, CHECK_INTERVAL, MAX_AGENT_STEPS, PROCS_PER_NODE
...
def verify_config():
    ...
    assert LAMBDA >= 0.0 and LAMBDA <= 1.0 and "Lambda must be in range [0.0, 1.0]"
